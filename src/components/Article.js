...
const Article = () => {
  ...
  const articleOpen = () => {
    dispatch(article_open({
      id: 'article', article: 'Сколько не находил ресурсов  для обучения по JS этот единственный, который поясняет последовательно и вполне ясно. Не хватает таких ресурсов по HTML & CSS.Уважение ребятам!' }
    ))
  }
  return (
